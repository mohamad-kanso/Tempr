...
- 🔜 Result grid displays streaming rows as they arrive; scrolling is smooth for result sets up to 100,000 rows *(streaming ✅; smoothness measured by the in-app `DebugScrollBenchmark` command — valid display-on run pending)*
