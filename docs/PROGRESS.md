...
- **Next action**: Start Phase 2 (Editor): rope buffer crate (`tempr_editor`), then tree-sitter PostgreSQL grammar; workspace open + connection picker (TODO "Now") is the first UI task alongside it
