...
- [ ] Run the scroll benchmark with the display on and the window focused; record fps / p95 / dropped in PROGRESS and flip the Phase 1 grid box; then profile any > 20 ms frames (per-frame histogram in `ScrollBench`)
