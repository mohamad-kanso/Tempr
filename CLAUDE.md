...
Phase: 0 — complete (2026-07-13). Phase 1 — in progress (database layer verified 2026-07-14; GPUI dependency, window shell, `Input` + streaming `ResultsGrid` landed 2026-09-03).
